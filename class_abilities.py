    ...
    for c in name.char_class:
        if "Cleric" == str(c):
            ...
            if name.char_abilities["STR"] > 15:
                name.char_class_xpBonus.append("+10%")
            if not "Fighter" not in name.char_class_abilities:
            ...
            name.char_class_abilities["Fighter"]["Specialization (UA) 1"] = "2x WP Slots for Spec, 3x WP Slots for Double Spec;" \
                                                                     "+1/+2 (Single) +3/+3 (Double (no missile, polearm," \
                                                                     "or 2h sword)"
            ...
            if name.char_abilities["STR"] > 15 and name.char_abilities["WIS"] > 15:
                name.char_class_xpBonus.append("+10%")
            if not "Paladin" not in name.char_class_abilities:
                name.char_class_abilities["Paladin"] = {}
            name.char_class_abilities["Paladin"]["Save Bonus"] = {}
            name.char_class_abilitiee["Paladin"]["Immunity"] = []
            ...
            if name.char_abilities["STR"] > 15 and name.char_abilities["WIS"] > 15 and name.char_abilities["INT"] > 15:
                name.char_class_xpBonus.append("+10%")
            if not "Ranger" not in name.char_class_abilities:
            ...
            name.char_class_abilities["Ranger"]["Special"] = "Tracking PHB Pg: 24"
            ...
            if not "Thief" not in name.char_class_abilities:
            ...
            if not "Assassin" not in name.char_class_abilities:
            ...
            if not "Monk" not in name.char_class_abilities:
            ...
            if not "Cavalier" not in name.char_class_abilities:
            ...
            if not "UAPaladin" not in name.char_class_abilities:
            ...
            if not "Barbarian" not in name.char_class_abilities:
            ...
            name.char_class_abilities["Barbarian"]["Thief"]["Climb Walls"] = ["85%",
                                                                         name.char_define_abilities["DEX"][
                                                                             "Hide In Shadows"]
                                                                         ]
            name.char_class_abilities["Barbarian"]["Thief"]["Hear Noise"] = ["10%",
                                                                        name.char_define_abilities["DEX"][
                                                                            "Hide In Shadows"]
                                                                        ]
            ...
            HP = dice.normal(12, 1) + int(HPadj) + 1
            name.char_HP += HP
    return name