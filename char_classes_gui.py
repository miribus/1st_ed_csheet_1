...
soclasslimit = {"LLC" : ["Monk", "Thief", "Assassin", "Barbarian",
                         "UAPaladin", "Cavalier"],
                "MLC" : ["Monk", "Thief", "Assassin", "Barbarian",
                         "Fighter", "FighterThief", "FighterAssassin",
                         "UAPaladin", "Cavalier"],
                "ULC": ["Monk", "Thief", "Assassin", "Barbarian",
                       "Fighter", "FighterThief", "FighterAssassin",
                       "UAPaladin", "Cavalier", "Druid", "Ranger",
                       "DruidFighter", "DruidRanger", "DruidThief"],
                "LMC": ["Monk", "Thief", "Assassin", "Barbarian",
                       "Fighter", "FighterThief", "FighterAssassin",
                       "UAPaladin", "Cavalier", "Druid", "Ranger",
                       "DruidFighter", "DruidRanger", "DruidThief",
                       "MagicUser", "Illusionist", "DruidMagicUSer",
                       "FighterMagicUser", "FighterIllusionist",
                       "FighterMagicUserThief", "RangerMagicUser",
                       "MagicUserThief", "MagicUserAssassin",
                       "IllusionistThief", "IllusionistAssassin"],
                "MMC": ["Monk", "Thief", "Assassin", "Barbarian",
                       "Fighter", "FighterThief", "FighterAssassin",
                       "UAPaladin", "Paladin", "Cavalier", "Druid", "Ranger",
                       "DruidFighter", "DruidRanger", "DruidThief",
                       "MagicUser", "Illusionist", "DruidMagicUSer",
                       "FighterMagicUser", "FighterIllusionist",
                       "FighterMagicUserThief", "RangerMagicUser",
                       "MagicUserThief", "MagicUserAssassin",
                       "IllusionistThief", "IllusionistAssassin",
                       "Cleric", "ClericFighter", "ClericMagicUser",
                       "ClericFighterMagicUser", "ClericRanger", "ClericThief",
                       "ClericAssassin", "ClericIllusionist", "ClericMagicUserThief",
                       "ClericFighterThief"],
                "UMC": ["Monk", "Thief", "Assassin", "Barbarian",
                       "Fighter", "FighterThief", "FighterAssassin",
                       "UAPaladin", "Paladin", "Cavalier", "Druid", "Ranger",
                       "DruidFighter", "DruidRanger", "DruidThief",
                       "MagicUser", "Illusionist", "DruidMagicUSer",
                       ...
                       "ClericAssassin", "ClericIllusionist", "ClericMagicUserThief",
                       "ClericFighterThief"],
                "LUC": ["Monk", "Thief", "Assassin", "Barbarian",
                       "Fighter", "FighterThief", "FighterAssassin",
                       "UAPaladin", "Paladin", "Cavalier", "Druid", "Ranger",
                       "DruidFighter", "DruidRanger", "DruidThief",
                       "MagicUser", "Illusionist", "DruidMagicUSer",
                       ...
                       "ClericAssassin", "ClericIllusionist", "ClericMagicUserThief",
                       "ClericFighterThief"],
                "MUC": ["Monk", "Thief", "Assassin", "Barbarian",
                       "Fighter", "FighterThief", "FighterAssassin",
                       "UAPaladin", "Paladin", "Cavalier", "Druid", "Ranger",
                       "DruidFighter", "DruidRanger", "DruidThief",
                       "MagicUser", "Illusionist", "DruidMagicUSer",
                       ...
                       "ClericAssassin", "ClericIllusionist", "ClericMagicUserThief",
                       "ClericFighterThief"],
                "UUC": ["Monk", "Thief", "Assassin", "Barbarian",
                       "Fighter", "FighterThief", "FighterAssassin",
                       "UAPaladin", "Paladin", "Cavalier", "Druid", "Ranger",
                       "DruidFighter", "DruidRanger", "DruidThief",
                       "MagicUser", "Illusionist", "DruidMagicUSer",
...
def race_classes(name):
    ...
    if name.methodv:
        ...
        name.char_class = name.methodv_choice
    else:
        #choices = input("Choose a Class NUMBER:")
        clear_screen()
    return classes, name

def choose_classes(name, choices):
    if not name.methodv:
        for rc in race_class_choices:
            if str(rc.name) == choices:
                choices = int(rc.value)
                break
    else:
        result = True
        return name, result
    ...
    if int(choices) in range(1, 37):
        ...
        while len(choices) > 0 and not stop:
            ...
            for c in name.classlist:
                ...
                valid_choice.append(name.classlist[-1])
                break
